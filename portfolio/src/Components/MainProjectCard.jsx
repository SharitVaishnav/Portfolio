...
const MainProjectCard = ({
  ...
  return (
    ...
    >
      ...
      >
        <p className="my-[10px] text-blue1 font-mono text-base font-semibold tracking-wider">
          Featured Project
        </p>

        <h3 className="text-slate-200 font-bold leading-[1.1] text-3xl transition-all duration-200 hover:text-blue1 font-fontHeading md:mb-[20px]">
          <a href={demo} target="_blank" rel="noopener noreferrer">
            {title}
          </a>
        </h3>

        <div className="shadow-none md:shadow-aboutShadow transition-all duration-200 relative z-[2] py-[20px] md:p-[25px] rounded text-slate-400 text-base bg-transparent md:bg-[#112240] font-fontParagraph md:hover:shadow-bigShadow">
          <p>{description}</p>
        </div>
        ...
        >
          {tags.map((tag, i) => (
            <li
              key={i}
              className="font-mono whitespace-nowrap text-sm text-slate-400 mr-[10px] mb-[5px] md:mr-[20px] md:mb-[5px]"
            >
              {tag}
            </li>
          ))}
        ...
        <div
          ...
          } text-slate-200 text-[22px]`}
        >
          <a
            href={github}
            className="flex justify-center items-center p-[10px] transition-all duration-200 hover:text-blue1"
            target="_blank"
      ...
      >
        ...
        >
          <div className="group w-full relative max-w-[700px] h-full">
            <div className="block relative w-full bg-blue1 shadow-aboutShadow  rounded-lg transition-all duration-500 mix-blend-screen group-hover:mix-blend-normal h-full z-[3]">
              <img
